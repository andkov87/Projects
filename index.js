const { HARD_WORDS_TO_GUESS: EASY_WORDS_TO_GUESS, HANGMAN_PICS, HARD_WORDS_TO_GUESS } = require('./constants');
...
To start the game, you have to choose the difficulty level,
by typing in 'easy' or 'hard'.
